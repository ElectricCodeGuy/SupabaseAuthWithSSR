          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <AnimatedSection>
              ...
              <p className="text-xl text-muted-foreground">
                Get up and running with the AI SDK in your Next.js application
                in just a few minutes. Follow these steps to build your first AI
                chat interface.
              </p>
            </AnimatedSection>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <AnimatedSection delay={0.2} className="mb-16">
              ...
              <p className="text-muted-foreground mb-4">
                Install the core AI SDK package along with your preferred
                provider package:
              </p>
...
npm install @ai-sdk/google      # For Google (Gemini)`}
            ...
            <AnimatedSection delay={0.3} className="mb-16">
              ...
              <p className="text-muted-foreground mb-4">
                Create a <code className="text-primary">.env.local</code> file
                in your project root and add your API keys:
              </p>
...
GOOGLE_GENERATIVE_AI_API_KEY=...`}
            ...
            <AnimatedSection delay={0.4} className="mb-16">
              ...
              <p className="text-muted-foreground mb-4">
                Create a new API route to handle chat requests. This example
...
export async function POST(req: Request) {
  ...
  return result.toDataStreamResponse();
            ...
            <AnimatedSection delay={0.5} className="mb-16">
              ...
              <p className="text-muted-foreground mb-4">
                Create a chat component using the useChat hook. In v5, messages
                contain a <code className="text-primary">parts</code> array for
                rich content:
              </p>
              <Card className="bg-zinc-950 border-zinc-800 overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        ...
                        and visit{' '}
                        <code className="text-primary">localhost:3000</code> to
                        see your AI chat in action.
                      </p>
